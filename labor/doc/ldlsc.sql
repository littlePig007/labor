...
-- Records of bio
-- ----------------------------
INSERT INTO `bio` VALUES ('2', '110', '宇信科技有限公司', '宇信科技', '10', '130', 'G0200', '230106000000', '50228', '50292059', '50292059@163.com', '哈尔滨香坊区88号当铺');
...
CREATE TABLE `zj_dwdjjdb` (
  ...
  CONSTRAINT `fk_jd_zpbh` FOREIGN KEY (`ZPBH`) REFERENCES `zj_dwzpdjb` (`ZPBH`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `zj_dwzpdjb` (
  `ZPBH` int(11) NOT NULL AUTO_INCREMENT,
  `DWBH` int(11) NOT NULL DEFAULT '0',
  ...
  `GDSJ` date DEFAULT NULL,
  PRIMARY KEY (`ZPBH`),
  KEY `FK_ZJ_DWZPD_REFERENCE_BIO` (`DWBH`),
  CONSTRAINT `fk_company_no` FOREIGN KEY (`DWBH`) REFERENCES `bio` (`bio_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of zj_dwzpdjb
-- ----------------------------
INSERT INTO `zj_dwzpdjb` VALUES ('2', '2', '李先军', '500228199604068888', '17745146929', '否', '17', '2018-05-03', null);
...
CREATE TABLE `zj_dwzpgzb` (
  `ZPGZBH` int(11) NOT NULL AUTO_INCREMENT,
  `ZPBH` int(11) NOT NULL,
  `ZPGZ` varchar(7) DEFAULT NULL,
  `ZPGZBM` varchar(32) DEFAULT NULL,
  `GWLB` varchar(2) DEFAULT NULL,
  `ZRS` int(4) DEFAULT NULL,
  `ZPRSN` int(4) DEFAULT NULL,
  `ZPRSNV` int(4) DEFAULT NULL,
  `XBBX` int(4) DEFAULT NULL,
  ...
  `CGRSN` int(4) DEFAULT NULL,
  `CGRSNV` int(4) DEFAULT NULL,
  `DJYXQ` int(2) DEFAULT NULL,
  `DJSJ` date DEFAULT NULL,
  `GDSJ` date DEFAULT NULL,
  PRIMARY KEY (`ZPGZBH`),
  KEY `fk_gz_zpbh` (`ZPBH`),
  CONSTRAINT `fk_gz_zpbh` FOREIGN KEY (`ZPBH`) REFERENCES `zj_dwzpdjb` (`ZPBH`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of zj_dwzpgzb
-- ----------------------------
INSERT INTO `zj_dwzpgzb` VALUES ('1', '2', '2000000', '后台开发', '90', '7', '2', '3', '2', '12', '2018-02-12', '2018-03-01', '22', '34', '80', '2', '3000', '4000', '1', '1', '30', '1', '110000000000', '14', '2', '1', '1', '后台开发', '北京三里屯', '0', '0', '17', '2018-05-03', null);
